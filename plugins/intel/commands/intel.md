...
`intelligence/<topic>/index.md`. `CLAUDE.md` holds only a fixed stanza pointing at the root index,
plus whatever unrelated content the user keeps there.
...
`intelligence/index.md` and `CLAUDE.md` shapes. Every branch writes or audits against those shapes.
